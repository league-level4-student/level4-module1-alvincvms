...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Use arrow keys to move, and eat fruits to grow!";
	...
	private void gameOver() {
		...
		int choice = JOptionPane.showOptionDialog(null, "Your snake is dead! Restart?", "Game Over", 0, -1, null, options, 0);
